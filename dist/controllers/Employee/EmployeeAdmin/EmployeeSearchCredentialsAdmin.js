...
class EmployeesSearchCredentialsAdminController {
  ...
  async SearchForActives(req, res, next) {
    try {
      const employeeActivesFinder = await _EmployeeSearchCredentials2.default.SearchByForActives();

      if (employeeActivesFinder.length < 1) throw new (0, _notFound.NotFound)('Nenhum funcionário ativo');
      if (!employeeActivesFinder) throw new (0, _serverErrors.InternalServerError)('Erro interno');
...
exports. default = new EmployeesSearchCredentialsAdminController();
